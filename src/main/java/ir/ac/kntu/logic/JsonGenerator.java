...
public class JsonGenerator {
    ...
    public static String generateBuyRecipe() {
        generateRandomTypes();
        return json.toString();
    }


    private static void generateRandomTypes() {
        json.append("{");
    ...
    private static void generateRandomGoods(String type) {
        String[] goodsList;
    ...
    private static void generateRandomGoodsDetails(String item, String type) {
    ...
    private static String generateRandomPrice(String type) {
        return switch (type) {
    ...
    private static String generateRandomPDate() {
        return "2022" + "-" + (rand.nextInt(12) + 1) + "-" + (rand.nextInt(30) + 1);
    }
    ...
    private static ArrayList<Integer> generateNonDuplicateRandomNumbers(int max) {
